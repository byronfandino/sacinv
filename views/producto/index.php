<header class="header__menu">
    <div class="titulo">
        <img src="/build/img/panelpago-bl.svg" alt="Icono de método de pago" width="30px" height="30px">
        <h1>Producto</h1>
    </div>
...
<?php
    if(isset($script) && $script != ''){
        $script .= '<script src="/build/js/producto/producto.js" type="module"></script>';        
